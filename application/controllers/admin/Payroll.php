...
// inout data to salate template
    ...
    public function delete_salary($id)
    {
        ...
        if (!empty($emp_salary_info->salary_template_id)) {
            $template_name = $this->db->where('salary_template_id', $id)->get('tbl_salary_template')->row()->salary_grade;
        } elseif (!empty($emp_salary_info->hourly_rate_id)) {
            $template_name = $this->db->where('hourly_rate_id', $id)->get('tbl_hourly_rate')->row()->hourly_grade;
        } else {
            $template_name = null;
        }
        // save into activities
