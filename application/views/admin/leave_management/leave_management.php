                            ...
                            <div class="table-responsive">
                                <table class="table table-striped DataTables " id="DataTables" cellspacing="0"
                                    ...
                                    if ($this->session->userdata('user_type') == 1) {
                                        $all_pending_leave = $this->db->get('tbl_leave_application')->result();
                                    } else {
                                        $all_pending_leave = $this->db->where('user_id', $this->session->userdata('user_id'))->get('tbl_leave_application')->result();
                                    }
