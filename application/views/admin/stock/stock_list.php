...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs" style="margin-top: 1px">
        ...
        <ul class="nav nav-tabs">
            <li class=""><a href="#task_list"
                                                               data-toggle="tab"><?= lang('all') . ' ' . lang('stock') ?></a>
            </li>
            <li class=" active"><a href="#assign_task"
                                                               data-toggle="tab"><?= lang('new') . ' ' . lang('stock') ?></a>
            </li>
        </ul>
        <div class="tab-content bg-white">
            <div class="tab-pane  " id="task_list" style="position: relative;">
                <?php } else { ?>
                ...
                <div class="tab-pane  active " id="assign_task" style="position: relative;">
