    ...
    <div class="panel-body">
        ...
        if (!empty($can_edit) && !empty($edited)) { ?>
            <a href="<?= base_url() ?>admin/invoice/manage_invoice/create_invoice/<?= $invoice_info->invoices_id ?>"
               class="pull-right btn btn-primary btn-xs"><?= $language_info['edit_invoice'] ?></a>
        <?php } ?>
        ...
        <div class="row mb-lg">
            <div class="col-lg-4 col-xs-6 br pv">
                <div class="row">
                    <div class="col-md-2 visible-md visible-lg">
                        <em class="fa fa-bell fa-4x text-muted"></em>
                    </div>
                    <div class="col-md-10">
            ...
            <div class="col-lg-4 col-xs-6 br pv">
                <div class="row">
                    <div class="col-md-2 visible-md visible-lg">
                        <em class="fa  fa-money" style="font-size:48px;"></em>
                    </div>
                    <?php
